...
기능: 예약 생성
  동일한 사이트와 기간에 대해 동시에 여러 예약 요청이 들어와도 단 하나의 예약만 성공해야 한다
...
기능: 연박 예약
  연박 예약 시 선택한 전체 기간 동안 해당 사이트가 이용 가능한 경우에만 예약이 성공해야 한다
...
기능: 가용성 확인
  특정 날짜의 사이트 가용성 조회 시 실시간으로 정확한 예약 가능 여부를 제공해야 한다
