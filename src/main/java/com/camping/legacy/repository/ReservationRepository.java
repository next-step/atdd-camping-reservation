...
public interface ReservationRepository extends JpaRepository<Reservation, Long> {
    ...
    boolean existsByCampsiteAndStartDateLessThanEqualAndEndDateGreaterThanEqualAndStatusNotIn(Campsite campsite, LocalDate endDate, LocalDate startDate, java.util.Collection<String> statuses);
