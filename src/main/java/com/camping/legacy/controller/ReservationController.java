...
import com.camping.legacy.domain.ReservationLockManager;
...
public class ReservationController {
    ...
    public ResponseEntity<?> createReservation(@RequestBody ReservationRequest request) {
        try {
            ReservationResponse response = reservationLockManager
                .lock(request.getSiteNumber(), () -> reservationService.createReservation(request));
