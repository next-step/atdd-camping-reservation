...
public class ReservationAcceptanceTest extends AcceptanceTestBase {
    ...
    private static final String 경계_예약_시작일 = "2026-02-03";
    private static final String 경계_예약_종료일 = "2026-02-05";

    private static final String 연속_예약_시작일 = "2026-02-04";
    private static final String 연속_예약_종료일 = "2026-02-06";

    private static final String 시작일_포함_예약_종료일 = "2026-02-02";
    ...
    void 기존_예약_종료일과_새_예약_시작일이_같으면_중복으로_거부() {
        ...
        // When
        var 김철수_예약요청 = 예약요청_생성(김철수, 경계_예약_시작일, 경계_예약_종료일, 사이트번호_A_1);
        var 김철수_예약결과정보 = 예약을_생성한다(김철수_예약요청);
    ...
    void 기존_예약_종료일_다음날부터_시작하면_예약_성공() {
        ...
        // When
        var 김철수_예약요청 = 예약요청_생성(김철수, 연속_예약_시작일, 연속_예약_종료일, 사이트번호_A_1);
        var 김철수_예약결과정보 = 예약을_생성한다(김철수_예약요청);
    ...
    void 기존_예약_시작일을_포함하는_기간으로_예약하면_거부() {
        ...
        // When
        var 김철수_예약요청 = 예약요청_생성(김철수, 기존예약_시작일, 시작일_포함_예약_종료일, 사이트번호_A_1);
        var 김철수_예약결과정보 = 예약을_생성한다(김철수_예약요청);
    ...
    void 기존_예약_종료일을_포함하는_기간으로_예약하면_거부() {
        ...
        // When
        var 김철수_예약요청 = 예약요청_생성(김철수, 중복예약_시작일, 기존예약_종료일, 사이트번호_A_1);
        var 김철수_예약결과정보 = 예약을_생성한다(김철수_예약요청);
    ...
    void 기존_예약을_완전히_포함하는_기간으로_예약하면_거부() {
        ...
        // Given
        var 홍길동_예약요청 = 예약요청_생성(홍길동, 중복예약_시작일, 기존예약_종료일, 사이트번호_A_1);
        예약을_생성한다(홍길동_예약요청);

        // When
        var 김철수_예약요청 = 예약요청_생성(김철수, 기존예약_시작일, 중복예약_종료일, 사이트번호_A_1);
        var 김철수_예약결과정보 = 예약을_생성한다(김철수_예약요청);
