...
class ReservationRequestTest {
    ...
    @Test
    void success(){
        assertDoesNotThrow(() -> ReservationRequestFixture.builder().build());
    }
    ...
    void 이름이_누락된_경우_예약_실패(String customerName) {
        ...
        RuntimeException exception = assertThrows(RuntimeException.class, () ->
                ReservationRequestFixture.builder().customerName(customerName).build()
        );
    ...
    void 전화번호_형식이_잘못된_경우_예약_실패(String phoneNumber) {
        // when, then
        RuntimeException exception = assertThrows(RuntimeException.class, () ->
                ReservationRequestFixture.builder().phoneNumber(phoneNumber).build()
        );
    ...
    void 캠핑장_번호를_입력하지_않은_경우_예약_실패(String siteNumber) {
        // when, then
        RuntimeException exception = assertThrows(RuntimeException.class, () ->
                ReservationRequestFixture.builder().siteNumber(siteNumber).build()
        );
    ...
    void 예약_기간을_입력하지_않은_경우_예약_실패() {
        ...
        RuntimeException exception1 = assertThrows(RuntimeException.class, () ->
                ReservationRequestFixture.builder().startDate(null).build()
        );
        assertThat(exception1.getMessage()).isEqualTo("예약 기간을 선택해주세요.");

        RuntimeException exception2 = assertThrows(RuntimeException.class, () ->
                ReservationRequestFixture.builder().endDate(null).build()
        );
